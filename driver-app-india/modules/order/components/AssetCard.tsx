...
//       const isFillRemaining = filledQuantity === 0 && assetsWithUploadedVideos.includes(assetId);
...
//       if (isFillRemaining) {
//         console.log('🎯 Scenario 1: Fill Remaining - Calling TOTALIZER_AFTER_READING API');
...
//         console.log('🎯 Scenario 2: Edit Quantity - Calling updateAssetQty and updating totalizer readings');
...
//           const task = await orderService.checkPartiallyFilledAssets(selectedOrder.id);
...
//               let previousTotalizerAfterValue = task.task_value[currentAssetIndex].value;
...
//                   const assetQuantity = taskAsset.customer_asset_id === assetId
//                     ? quantity
...
//                   console.log(`  Asset ${taskAsset.customer_asset_id}: +${assetQuantity} = ${previousTotalizerAfterValue}`);
//                 }
//               }
...
//       else {
//         console.log('🎯 Scenario 3: Regular quantity update (non-buddycan flow)');
