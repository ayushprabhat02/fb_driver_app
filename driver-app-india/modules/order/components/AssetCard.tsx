  ...
  const handleQuantityUpdate = async (quantity: number) => {
    ...
    try {
      ...
      // SCENARIO 2: Edit Quantity - Following Vue.js AssetCard.vue logic (lines 237-280)
        ...
        console.log(
          '📝 Calling TOTALIZER_AFTER_READING API for edit quantity...',
        );
        const coordinates = await getCurrentLocation();
        ...
        console.log(
          '✅ TOTALIZER_AFTER_READING API called successfully for edit quantity',
        );
      ...
      // SCENARIO 3: Regular quantity update (non-buddycan flow)
        ...
        if (isEditQuantity) {
          console.log(
            '📝 Calling TOTALIZER_AFTER_READING API for edit quantity (non-buddycan flow)...',
          );
          const coordinates = await getCurrentLocation();
          await orderService.upsertStepTaskAction({
            object: {
          ...
          console.log(
            '✅ TOTALIZER_AFTER_READING API called successfully for edit (non-buddycan)',
          );
        }
      }
