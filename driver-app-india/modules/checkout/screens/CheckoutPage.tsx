...
const CheckoutPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const driverName =
        `${firstName} ${middleName} ${lastName}`.trim() || 'Driver';
      ...
      const response = await checkoutService.driverCheckOut({
        object: checkoutData,
      });
      ...
      if (response) {
        ...
        checkoutStore.setState({
          ...
          loaders: {
            ...
            isCheckingOut: true, // Keep loader running
          },
        });
    ...
    <HeaderAvoidingContainer paddingHorizontal={0}>
      ...
      <View style={styles.buttonContainer}>
        <Button
          style={[
            styles.button,
            (!selfieStoreUrl || !refuellerStoreUrl || isCheckingOut) &&
